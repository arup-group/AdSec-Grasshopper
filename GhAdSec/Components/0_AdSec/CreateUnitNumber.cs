...
namespace GhAdSec.Components
{
    ...
    public class CreateUnitNumber : GH_Component, IGH_VariableParameterComponent
    {
        ...
        protected override System.Drawing.Bitmap Icon => GhAdSec.Properties.Resources.CreateUnitNumber;
        #endregion
        ...
        public override void CreateAttributes()
        {
            if (first)
            {
                ...
                // unit types
                dropdownitems.Add(Enum.GetNames(typeof(GhAdSec.DocumentUnits.AdSecUnits)).ToList());
