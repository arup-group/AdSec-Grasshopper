...
namespace AdSecGH.Parameters
{
    public class AdSecRebarLayerGoo : GH_Goo<ILayer>
    {
        ...
        {
            string bar = "";
            UnitsNet.Length dia = this.Value.BarBundle.Diameter.ToUnit(AdSecGH.DocumentUnits.LengthUnit);
            bar += "Ø" + dia.ToString();
            ...
            catch (Exception)
            {
                try
                {
                    ...
                    UnitsNet.Length spacing = byBarPitch.Pitch.ToUnit(AdSecGH.DocumentUnits.LengthUnit);
