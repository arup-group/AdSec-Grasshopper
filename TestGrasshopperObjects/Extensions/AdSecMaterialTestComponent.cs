...
namespace TestGrasshopperObjects.Extensions {
  public class AdSecMaterialTestComponent : GH_OasysComponent {
    public bool Optional { get; set; }
    public AdSecMaterialTestComponent() : base("t0", "t1", "t2", "t3", "t4") { }
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      var result = this.GetAdSecMaterial(da, 0, Optional);
      da.SetData(0, result);
    }
