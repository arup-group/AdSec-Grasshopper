...
namespace TestGrasshopperObjects.Extensions {
  public class AdSecRebarLayerGooTestComponent : GH_OasysComponent {
    public bool Optional { get; set; }
    public AdSecRebarLayerGooTestComponent() : base("t0", "t1", "t2", "t3", "t4") { }
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      var result = this.GetAdSecRebarLayerGoo(DA, 0, Optional);
      DA.SetData(0, result);
    }
