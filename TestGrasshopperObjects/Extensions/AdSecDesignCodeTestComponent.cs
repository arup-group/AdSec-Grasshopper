...
namespace TestGrasshopperObjects.Extensions {
  public class AdSecDesignCodeTestComponent : GH_OasysComponent {
    public bool Optional { get; set; }
    public AdSecDesignCodeTestComponent() : base("t0", "t1", "t2", "t3", "t4") { }
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      var result = this.GetAdSecDesignCode(da, 0, Optional);
      da.SetData(0, result);
    }
  }
}
