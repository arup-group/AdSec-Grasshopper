...
namespace TestGrasshopperObjects.Extensions {
  public class AdSecSolutionGooTestComponent : GH_OasysComponent {
    public bool Optional { get; set; }
    public AdSecSolutionGooTestComponent() : base("t0", "t1", "t2", "t3", "t4") { }
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      var result = this.GetSolutionGoo(da, 0, Optional);
      da.SetData(0, result);
    }
