...
namespace AdSecGHTests.Helpers.Extensions {
  ...
  public class AdSecSubComponentsTests {
    private AdSecSubComponentsTestComponent _component;
    ...
    public AdSecSubComponentsTests() {
      _component = new AdSecSubComponentsTestComponent();
    }
    ...
    [Fact]
    public void ReturnsSubComponentsWhenDataCorrect() {
      var input = GetAdSecSectionGoo();
