...
omponents {
  ...
  public override OasysPluginInfo PluginInfo => AdSecGH.PluginInfo.AdSecGH.PluginInfoected override Bitmap Icon => Resources.SaveAdSec;
  ...
  private void SaveJson() {
    try {
      System.IO.File.WritFileName, _jsonString);
      canOpen = true;
    } catch (Exception e) {
