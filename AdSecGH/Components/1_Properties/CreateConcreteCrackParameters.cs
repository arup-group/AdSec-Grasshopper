...
namespace AdSecGH.Components {
  public class CreateConcreteCrackParameters : GH_OasysDropDownComponent {
    ...
    public CreateConcreteCrackParameters() : base("Create CrackCalcParams", "CrackCalcParams",
      "Create Concrete Crack Calculation Parameters for AdSec Material", CategoryName.Name(), SubCategoryName.Cat1()) {
    ...
    protected override Bitmap Icon => Resources.CreateCrackCalcParams;
