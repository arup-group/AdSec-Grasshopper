...
namespace AdSecGH.Components {
  public class ResultsSLS : GH_OasysComponent {
    ...
    public ResultsSLS() : base("Serviceability Result", "SLS",
      "Performs serviceability analysis (SLS), for a given Load or Deformation.", CategoryName.Name(),
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      ...
      DA.SetData(4,
        new Vector3d(sls.Deformation.X.As(DefaultUnits.StrainUnitResult),
          sls.Deformation.YY.As(DefaultUnits.CurvatureUnit), sls.Deformation.ZZ.As(DefaultUnits.CurvatureUnit)));

      DA.SetData(5,
        new Vector3d(sls.SecantStiffness.X.As(DefaultUnits.AxialStiffnessUnit),
